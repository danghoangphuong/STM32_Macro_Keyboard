...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    GPIO_InitStruct.Pin = DS1307_SCL_Pin|DS1307_SDA_Pin;
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(DS1307_SCL_GPIO_Port, DS1307_SCL_Pin);

    HAL_GPIO_DeInit(DS1307_SDA_GPIO_Port, DS1307_SDA_Pin);
